...
Version 8.2.1:
    1.  Remove the randomly sampling of negative samples.
Version 8.2.1.random:
    1.  Add random shuffling operation remove the meta-path.
"""

logger = get_child_logger("Wiki.Entity.Path.V8.2.1.random")
...
def convert_examples_into_features(file_path: str, tokenizer: PreTrainedTokenizer,
    ...
    file_suffix = f"{tokenizer_name}_{shuffle_context}_{max_neg_num}_{aug_num}_" \
                  ...
                  f"{deduct_ratio}_{context_ratio}_{'' if not remove_context else 'no-ctx-ex_'}path_v8_2_1"
