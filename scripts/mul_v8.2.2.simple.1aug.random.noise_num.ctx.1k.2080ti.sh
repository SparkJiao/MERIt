...
for seed in 42 43 44 45 4321; do
  python -m torch.distributed.launch --nproc_per_node 2 reclor_trainer_base_v2.py seed=$seed -cp conf/roberta/original -cn ft_et0_v8_2_2_simple_1aug_random_noise_num_ctx_1k
done;
